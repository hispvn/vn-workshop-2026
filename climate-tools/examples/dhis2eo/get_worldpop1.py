"""Download WorldPop population data (global1 version) and print values.
...
This script uses the "global1" version (2000-2020, ~1km resolution), which is the
older UN-adjusted unconstrained dataset. For the newer version (2015-2030, 100m
resolution), see get_worldpop2.py.
...
Usage:
  uv run python examples/dhis2eo/get_worldpop1.py --country-code SLE
  uv run python examples/dhis2eo/get_worldpop1.py --country-code SLE --start 2018 --end 2020
"""
...
parser = argparse.ArgumentParser(description="Download WorldPop population data (global1)")
...
print(f"Downloading WorldPop global1 data for {args.country_code}...")
...
print("\nWorldPop population data (global1):")
